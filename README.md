...
5.- Rename file __.template.env__ to __.develop.env__

6.- Fill yours envs in the file __.develop.env__
...
8.- Generate migrations (skip this step)
```
pnpm run m:gen:dev src/migrations/'initPro'
```
